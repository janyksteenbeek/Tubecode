...
$allNamedPolicies =  Pascal\YouTubeApiHelper::get_named_policies($partner,new \Pascal\ContentOwner(CONTENT_OWNER));

echo "<table>";

foreach($allNamedPolicies as $policy => $id){
    echo "<tr><td>$policy</td><td>$id</td></tr>";
}
